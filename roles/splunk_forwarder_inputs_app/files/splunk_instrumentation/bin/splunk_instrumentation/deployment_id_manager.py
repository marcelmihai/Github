...
class DeploymentIdManager(object):
    ...
    def __init__(self, splunkd, telemetry_conf_service=None, server_info_service=None, prefix=None):
        self.services = ServiceBundle(splunkd,
    ...
    def generate_new_deployment_id(self, prefix=None):
        '''
    ...
    def kv_store_deployment_id(self):
        ...
        try:
            if not self._kv_store_deployment_id:
                resp = self.splunkd.get(constants.ENDPOINTS['KV_STORE']['DEPLOYMENT_ID'],
